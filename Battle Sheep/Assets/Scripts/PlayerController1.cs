...
public class PlayerController1 : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        GameData.GetScores()[0] = CalculateScore();
    ...
    bool HandleClick()
    {
        Debug.Log("X "+this.gameObject.GetComponent<Camera>().ScreenToWorldPoint(Input.mousePosition).x);
        Debug.Log("Y "+this.gameObject.GetComponent<Camera>().ScreenToWorldPoint(Input.mousePosition).y);
